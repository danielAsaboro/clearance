      ...
      if (res.ok) {
        ...
        if (current) {
          const sessionState = getSessionState({
            ...
            lateJoinCutoff: current.lateJoinCutoff ? new Date(current.lateJoinCutoff) : null,
          } as never)
      ...
      <div className="spotr-page flex flex-1 flex-col">
        ...
        <div className="spotr-mobile-shell flex flex-1 flex-col gap-4 px-5 py-4">
          ...
          <div className="rounded-[20px] bg-[#f5d63d] px-5 py-6 text-center text-black">
            <p className="text-[11px] font-semibold uppercase tracking-[0.10em] text-black/55">SESSION ENTRY</p>
          ...
          <p className="spotr-screen-footer pt-1 text-center">One session per wallet. Make it count!</p>
        </div>
      </div>
    )
  }
